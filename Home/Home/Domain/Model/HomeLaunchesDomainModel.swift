...
public struct HomeLaunchesDomainModel: Equatable, Identifiable {
...
extension HomeLaunchesDomainModel: IdentifiableType {
  ...
  public static func == (lhs: HomeLaunchesDomainModel, rhs: HomeLaunchesDomainModel) -> Bool {
